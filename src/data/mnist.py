...
class MNIST(object):
    ...
    def load_data(self):
        ...
        self.trainset = datasets.MNIST(root=self.data_root, train=True, download=True, transform=train_transform)
        self.testset = datasets.MNIST(root=self.data_root, train=False, download=True, transform=test_transform)
